...
use Tests\Feature\DataProviders\UserFolloweeDataProvider;
use Tests\TestCase;

/**
 * フォロイー一覧
 *
 * Class UserFolloweeTest
 * @package Tests\Feature
 */
class UserFolloweeTest extends TestCase
{
    use UserFolloweeDataProvider;
